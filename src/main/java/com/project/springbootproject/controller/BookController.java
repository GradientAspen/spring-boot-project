...
@Tag(name = "Books controller", description = "Endpoint for managing books")
@RestController
...
public class BookController {
    ...
    @PostMapping
    @Operation(summary = "Add book in DB", description = "Add book in DB")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete book from DB", description = "Delete book from Db")
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @Operation(summary = "Update information about book", description = "Update information about book")
    public void updateBook(@PathVariable Long id, @RequestBody BookRequestDto bookDto) {
        bookService.updateBook(bookDto, id);
    }

    @GetMapping("/search")
    @Operation(summary = "Search book with parameters", description = "Search books with parameters")
